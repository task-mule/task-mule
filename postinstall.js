...
var BANNER = '\u001B[96mThanks for using Task-MUle! See the README for help and to support the developer: \u001B[94m https://github.com/task-mule/task-mule/blob/master/README.md \u001B[96m\u001B[0m\n\n';

function isBannerRequired() {
  if (ADBLOCK || CI || DISABLE_OPENCOLLECTIVE || SILENT) return false;
  var file = path.join(os.tmpdir(), 'tm-banners');
  var banners = [];
  try {
